    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit}>
                <InputGroup handleChange={setFirstname}label="firstame" type="text" required />
                <InputGroup handleChange={setLastname}label="lastname" type="text" required />
                <InputGroup handleChange={setUsername}label="Username" type="text" required/>
